...
@interface ZMSearchVC ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.searchArr.count > 0) {
        ZMClassItem *item = self.searchArr[indexPath.row];
...
- (void)loadCarouselData
{
    ...
    [ZMHttpTool post:ZMItemUrl params:parameters success:^(id responseObj) {
        ...
        NSArray *arr = [ZMClassItem mj_objectArrayWithKeyValuesArray:dict];
